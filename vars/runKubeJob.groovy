// vars/runKubeJob.groovy
def call(String jobName, String deploymentImageName, String deploymentContext, String deploymentNamespace, String shortCommit, Map envVars)
{
    Map kubeJobTmp = [
        apiVersion: "batch/v1",
        kind: "Job",
